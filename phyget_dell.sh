...
addUser () {
  #local IpN UserN PassN UserIdN
  #echo $IpN $UserN $PassN $UserIdN
  IpN=$1
  echo 
  $ExeCmd -r $IpN -u $User -p $Pass --nocertwarn set idrac.users.${UserIdN}.UserName $UserN &> /dev/null && echo "  setting username success"
  $ExeCmd -r $IpN -u $User -p $Pass --nocertwarn set idrac.users.${UserIdN}.Password $PassN &> /dev/null && echo "  setting password success"
  
  $ExeCmd -r $IpN -u $User -p $Pass --nocertwarn set idrac.users.${UserIdN}.Privilege 0x1ff &> /dev/null && echo "  setting privilege success"
  $ExeCmd -r $IpN -u $User -p $Pass --nocertwarn set idrac.users.${UserIdN}.Enable Enabled &> /dev/null && echo "  setting user enabled"
  	   
  $ExeCmd -r $IpN -u $User -p $Pass --nocertwarn set idrac.users.${UserIdN}.IpmiLanPrivilege 4 &> /dev/null && echo "  setting IpmiLanPrivilege success"
  $ExeCmd -r $IpN -u $User -p $Pass --nocertwarn set idrac.users.${UserIdN}.IpmiSerialPrivilege 4 &> /dev/null && echo "  setting IpmiSerialPrivilege success"
  $ExeCmd -r $IpN -u $User -p $Pass --nocertwarn set idrac.users.${UserIdN}.SolEnable Enabled &> /dev/null && echo "  setting SolEnable enable"
  	   
  $ExeCmd -r $IpN -u $User -p $Pass --nocertwarn set idrac.users.${UserIdN}.ProtocolEnable Disabled &> /dev/null && echo "  setting snmpv3 disable"
  $ExeCmd -r $IpN -u $User -p $Pass --nocertwarn set idrac.users.${UserIdN}.AuthenticationProtocol SHA &> /dev/null && echo "  setting AuthenticationProtocol success"
  $ExeCmd -r $IpN -u $User -p $Pass --nocertwarn set idrac.users.${UserIdN}.PrivacyProtocol AES &> /dev/null && echo "  setting PrivacyProtocol success"
}
...
#  #echo $IpN $UserN $PassN $UserIdN
#  addUser $IpN $UserIdN $UserN $PassN 
#}
